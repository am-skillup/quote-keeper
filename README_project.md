...
**Suggested quick project (optional): Quote Keeper**

If you'd like a simple, testable project to complete quickly, try **Quote Keeper**: a small REST service to store and retrieve quotes (text, author, tags), with a tiny frontend and automated tests. A full scaffold is provided in `project/quote-keeper/` to get you started—edit, extend, and deploy it as your project submission.
